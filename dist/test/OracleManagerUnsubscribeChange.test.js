...
describe('OracleManagerUnsubscribeChange', function () {
    it('should succeed execute call', async function () {
        ...
        await contracts.governor.mint(contracts.token.address, oracleOwner.account.address, 1800n * 10n ** 18n);
...
//# sourceMappingURL=OracleManagerUnsubscribeChange.test.js.map