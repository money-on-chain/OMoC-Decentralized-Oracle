...
describe('StakingRewards', function () {
                ...
                byUserAmount: [
                    {
                        ...
                        cases: [
                            {
                                testNumber: '1',
                                description: 'Alice deposits 1 moc, has 1 reward, moc balance after is 1',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '2',
                                description: 'Alice deposits 2 moc, has 1 reward, moc balance after is 2',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '3',
                                description: 'Alice deposits 3 moc, has 1 reward, moc balance after is 3',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '4',
                                description: 'Alice deposits 1 moc, has 2 reward, moc balance after is 1',
                                reward: '2',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '5',
                                description: 'Alice deposits 2 moc, has 2 reward, moc balance after is 2',
                                reward: '2',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '6',
                                description: 'Alice deposits 3 moc, has 2 reward, moc balance after is 3',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                    ...
                    },
                    {
                        ...
                        cases: [
                            {
                                testNumber: '7',
                                description: 'Alice deposits 1 moc, Bob 1, has 1 reward, Alice moc balance after is 1, Bob 1',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '8',
                                description: 'Alice deposits 2 moc, Bob 2, has 1 reward, Alice moc balance after is 2, Bob 2',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '9',
                                description: 'Alice deposits 3 moc, Bob 3, has 1 reward, Alice moc balance after is 3, Bob 3',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '10',
                                description: 'Alice deposits 1 moc, Bob 1, has 2 reward, Alice moc balance after is 1, Bob 1',
                                reward: '2',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '11',
                                description: 'Alice deposits 2 moc, Bob 2, has 2 reward, Alice moc balance after is 2, Bob 2',
                                reward: '2',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '12',
                                description: 'Alice deposits 3 moc, Bob 3, has 2 reward, Alice moc balance after is 3, Bob 3',
                                reward: '2',
                                users: [
                                    {
                                        name: 'ALICE',
                ...
                byUserAmount: [
                    ...
                    },
                    {
                        ...
                        cases: [
                            {
                                testNumber: '42',
                                description: 'Alice deposits 1 moc, Bob 1, Charlie 1, has 1 reward, Alice moc balance after is 1, Bob 1, Charlie 1',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '43',
                                description: 'Alice deposits 2 moc, Bob 2, Charlie 2, has 1 reward, Alice moc balance after is 2, Bob 2, Charlie 2',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '44',
                                description: 'Alice deposits 3 moc, Bob 3, Charlie 3, has 1 reward, Alice moc balance after is 3, Bob 3, Charlie 3',
                                reward: '1',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '45',
                                description: 'Alice deposits 1 moc, Bob 1, Charlie 1, has 2 reward, Alice moc balance after is 1, Bob 1, Charlie 1',
                                reward: '2',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '46',
                                description: 'Alice deposits 2 moc, Bob 2, Charlie 2, has 2 reward, Alice moc balance after is 2, Bob 2, Charlie 2',
                                reward: '2',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '47',
                                description: 'Alice deposits 3 moc, Bob 3, Charlie 3, has 2 reward, Alice moc balance after is 3, Bob 3, Charlie 3',
                                reward: '2',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '48',
                                description: 'Alice deposits 1 moc, Bob 1, Charlie 1, has 4 reward, Alice moc balance after is 1, Bob 1, Charlie 1',
                                reward: '4',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '49',
                                description: 'Alice deposits 2 moc, Bob 2, Charlie 2, has 4 reward, Alice moc balance after is 2, Bob 2, Charlie 2',
                                reward: '4',
                                users: [
                                    {
                                        name: 'ALICE',
                            ...
                            {
                                testNumber: '50',
                                description: 'Alice deposits 3 moc, Bob 3, Charlie 3, has 4 reward, Alice moc balance after is 3, Bob 3, Charlie 3',
                                reward: '4',
                                users: [
                                    {
                                        name: 'ALICE',
    ...
    describe('Should check reward distribution in cases with a period of 1 block', async () => {
        ...
        log('PERIOD', period);
        beforeEach(async () => {
            contractSet = await initContracts(deployer, accounts[8], BigInt(period), BigInt(minCPSubscriptionStake));
    ...
    async function checkRewardDistribution(testValues, period, contracts) {
        ...
        for (let userIndex1 = 0; userIndex1 < testValues.users.length; userIndex1++) {
            ...
            await contracts.token.write.approve([contracts.staking.address, testValues.users[userIndex1].depositAmount], {
                account: user1Account,
            });
            log('Making deposit of', testValues.users[userIndex1].depositAmount, 'mocs by ' + testValues.users[userIndex1].name + '<---------------');
            // Deposit mocs in Staking
            await contracts.staking.write.deposit([testValues.users[userIndex1].depositAmount, user1Address], {
                account: user1Account,
            });
            ...
            log(testValues.users[userIndex1].name + "'s moc balance after first deposit", mocBalanceAfterFirstDeposit.toString(), 'Expected:', testValues.users[userIndex1].mocBalanceAfterDeposit);
            log(testValues.users[userIndex1].name + "'s internal token balance after first deposit", tokenBalanceAfterFirstDeposit.toString(), 'Expected:', testValues.users[userIndex1].tokenBalanceAfterDeposit);
            // Check stake in mocs was deposited
            expect(mocBalanceAfterFirstDeposit.toString()).to.be.equal(testValues.users[userIndex1].mocBalanceAfterDeposit);
            // Check internal token balance was updated.
            expect(tokenBalanceAfterFirstDeposit.toString()).to.be.equal(testValues.users[userIndex1].tokenBalanceAfterDeposit);
        }
        //////////////////////////////////////////
        ...
        expect((supportersBalanceAfterTransfer - supportersBalanceBeforeTransfer).toString()).to.be.equal(testValues.reward);
        ...
        for (let userIndex2 = 0; userIndex2 < testValues.users.length; userIndex2++) {
            ...
            log(testValues.users[userIndex2].name + "'s moc balance after reward transfer", mocBalanceAfterReward.toString(), 'Expected:', testValues.users[userIndex2].mocBalanceAfterReward);
            log(testValues.users[userIndex2].name +
                "'s internal token balance after reward transfer", tokenBalanceAfterReward.toString(), 'Expected:', testValues.users[userIndex2].tokenBalanceAfterReward);
            // Check stake in mocs after reward transfer
            expect(mocBalanceAfterReward.toString()).to.be.equal(testValues.users[userIndex2].mocBalanceAfterReward);
            // Check internal token balance after reward transfer
            expect(tokenBalanceAfterReward.toString()).to.be.equal(testValues.users[userIndex2].tokenBalanceAfterReward);
        }
        //////////////////////////////////////////
        ...
        for (let j = 1; j <= period; j++) {
            for (let k = 0; k < testValues.users.length; k++) {
                ...
                log(testValues.users[k].name +
                    "'s moc balance after " +
                    j.toString() +
                    ' period blocks', mocBalance.toString(), 'Expected:', testValues.users[k].periodValues[j].mocBalance);
                log(testValues.users[k].name +
                    "'s internal token balance after " +
                    j.toString() +
                    ' period blocks', tokenBalance.toString(), 'Expected:', testValues.users[k].periodValues[j].tokenBalance);
                // Check user's stake in mocs
                expect(mocBalance.toString()).to.be.equal(testValues.users[k].periodValues[j].mocBalance);
                // Check user's internal token balance
                expect(tokenBalance.toString()).to.be.equal(testValues.users[k].periodValues[j].tokenBalance);
            }
