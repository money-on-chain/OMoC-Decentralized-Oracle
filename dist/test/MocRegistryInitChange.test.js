...
describe('MocRegistryInitChange', function () {
    it('should succeed execute call', async function () {
        ...
        assertSameAddress(await registry.read.getAddress([key('ORACLE_MANAGER_ADDR')]), contracts.oracleMgr.address);
    });
});
//# sourceMappingURL=MocRegistryInitChange.test.js.map