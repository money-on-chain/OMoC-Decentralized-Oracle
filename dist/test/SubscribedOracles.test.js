...
describe('SubscribedOracles', function () {
    ...
    async function addOracles(subscribedOracles) {
    ...
    it('sort', async function () {
        ...
        while (i < selected.length) {
            ...
            expect(Number(stake), 'Stake should be in decreasing order').to.be.greaterThanOrEqual(Number(next));
            stake = next;
            i += 1;
        }
...
//# sourceMappingURL=SubscribedOracles.test.js.map