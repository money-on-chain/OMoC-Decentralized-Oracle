...
describe('InfoGetter', function () {
    ...
    before(async function () {
        ...
        coinPairPrice = await initCoinpair(deployer, COINPAIR_NAME, contracts.governor, contracts.token, contracts.oracleMgr, contracts.registry, [accounts[0].account.address, infoGetter.address], 3n, 3n, 60n, 0n, 3n);
        const oracles = [
            {
                owner: accounts[2],
                signer: accounts[3],
        ...
        for (const oracle of oracles) {
            await contracts.governor.mint(contracts.token.address, oracle.owner.account.address, ORACLE_STAKE);
...
//# sourceMappingURL=InfoGetter.test.js.map