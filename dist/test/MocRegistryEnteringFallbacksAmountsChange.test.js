...
describe('MocRegistryEnteringFallbacksAmountsChange', function () {
    it('should succeed execute call', async function () {
        ...
        expect(await registry.read.getBytes([key('ORACLE_ENTERING_FALLBACKS_AMOUNTS')])).to.equal('0x010204');
    });
});
//# sourceMappingURL=MocRegistryEnteringFallbacksAmountsChange.test.js.map