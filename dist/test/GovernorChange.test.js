...
describe('GovernorChange', function () {
    it('should succeed execute call', async function () {
        ...
        assertSameAddress(await contracts.coinPairPriceBTCUSD.read.governor(), contracts.governor.address);
        assertSameAddress(await contracts.coinPairPriceRIFBTC.read.governor(), contracts.governor.address);
        expect(await governorChange.read.newGovernor()).to.equal('0x0000000000000000000000000000000000000000');
    });
});
//# sourceMappingURL=GovernorChange.test.js.map