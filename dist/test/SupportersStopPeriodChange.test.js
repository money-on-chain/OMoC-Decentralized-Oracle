...
const toWei = (value) => value * 10n ** 18n;
...
describe('SupportersStopPeriodChange', function () {
    ...
    async function checkBalances(distributedEarnings) {
        let totalBalance = 0n;
    ...
    beforeEach(async function () {
        ...
        users = accounts.slice(5, 5 + balances.length);
    ...
    it('Distribute should fail if contract not ready to distribute', async function () {
        ...
        await viem.assertions.revertWith(supporters.write.distribute({ account: caller.account }), 'Not ready to distribute');
...
//# sourceMappingURL=SupportersStopPeriodChange.test.js.map