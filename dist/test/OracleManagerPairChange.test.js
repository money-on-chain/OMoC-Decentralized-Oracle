...
describe('OracleManagerPairChange', function () {
    it('should succeed execute call', async function () {
        ...
        assertSameAddress(contractAddr, await contracts.oracleMgr.read.getContractAddress([encodeCoinPair('RIFUSD')]));
    });
});
//# sourceMappingURL=OracleManagerPairChange.test.js.map