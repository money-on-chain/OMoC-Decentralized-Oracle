...
describe('SupportersMock', function () {
    ...
    describe('Deposits', function () {
        ...
        it('deposit earnings', async function () {
            ...
            await viem.assertions.revertWith(supporters.write.distribute({ account: payer }), 'Not ready to distribute');
    ...
    describe('Stake HUGE amount', function () {
        ...
        it('handles the legacy overflow boundary scenario', async function () {
            ...
            await assert.rejects(supporters.read.getMOCBalance([user1.address]), /SafeMath: multiplication overflow/);
            ...
            await assert.rejects(supporters.read.getMOCBalance([user2.address]), /SafeMath: multiplication overflow/);
            await token.write.approve([supporters.address, USER3_BALANCE], {
                account: user3,
            });
            await viem.assertions.revertWith(supporters.write.stake([USER3_BALANCE], { account: user3 }), 'SafeMath: multiplication overflow');
...
//# sourceMappingURL=SupportersMock.test.js.map