...
async function deploy(config) {
    ...
    if (config.externalGovernorAddr)
        console.log('Using external governor', config.externalGovernorAddr);
    if (config.externalProxyAdminAddr)
        console.log('Using external proxyAdmin', config.externalProxyAdminAddr);
