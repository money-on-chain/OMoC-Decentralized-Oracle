...
This repository contains the **Smart Contracts**' source code _**only**_ and its related utilities and tests. The off-chain part of this system is available at [money-on-chain/OMoC-Node](https://github.com/money-on-chain/OMoC-Node).
